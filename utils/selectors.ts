...
let campaign_selectors: {
	...
	select_campaign: (campaign_name: string) => `//a[contains(text(),"${campaign_name}")]`,
	...
	exclude_tag_placeholder: '//label[contains(text(),"Choose tag to exclude")]/..//span[@class="multiselect__placeholder"]',
	exclude_tag_input: '//label[contains(text(),"Choose tag to exclude")]/..//input[@class="multiselect__input"]',
	exclude_segment_select: '//span[contains(text(),"By Segment")]',
	exclude_segment_placeholder: '//label[contains(text(),"Choose segment to exclude")]/..//span[@class="multiselect__placeholder"]',
	exclude_segment_input: '//label[contains(text(),"Choose segment to exclude")]/..//input[@class="multiselect__input"]',
...
let form_submit: {
	...
	subscribe: '//button[@class="submit-button" and contains(text(), "Join Today")]',
...
let integration_create_affiliate: {
	...
	username: "#user_name",
	select_affiliate: (affiliate_username: string) => `//div[@class="ui-menu-item-wrapper" and contains(text(), ${affiliate_username})]`,
...
let integration_affiliate_actions: {
	...
	select_affiliate: (affiliate_username: string) => `//a[text()="${affiliate_username}"]/../..//input[@type="checkbox"]`,
...
let integration_map_cf7: {
	...
	check_cf7: (cf7_name: string) => `//h3[@class="title clearfix" and contains(text(), "${cf7_name}")]//input[@type="checkbox"]`,
	select_cf7: (cf7_name: string) => `//h3[@class="title clearfix" and contains(text(), "${cf7_name}")]/..//div[@class="multiselect__tags"]`,
	select_list: (cf7_name: string) => `//h3[@class="title clearfix" and contains(text(), "${cf7_name}")]/..//div[@class="multiselect__tags"]//input[@type="text"]`,
	override: (cf7_name: string) => `//h3[@class="title clearfix" and contains(text(), "${cf7_name}")]/../form//input[@type="checkbox"]`,
	select_name: (cf7_name: string) => `(//h3[@class="title clearfix" and contains(text(), "${cf7_name}")]/..//select)[1]`,
	select_email: (cf7_name: string) => `(//h3[@class="title clearfix" and contains(text(), "${cf7_name}")]/..//select)[2]`,
...
let integration_delete_cf7: {
	...
	select_cf7: (cf7_name: string) => `//a[text()="${cf7_name}"]/../../..//input[@type="checkbox"]`,
...
let wp_user: {
	...
	select_user: (username: string) => `//a[text()="${username}"]/../../..//input[@type="checkbox"]`,
};
